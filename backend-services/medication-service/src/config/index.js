...
module.exports = {
    ...
    GRPC_PORT: process.env.GRPC_PORT || 50057,
    ...
    db: {
        ...
        database: process.env.DB_DATABASE || 'bs_medication_db',
    ...
    // ⭐ RPC 服务配置
    rpc:{
        secureExchangeService: process.env.SECURE_EXCHANGE_RPC_SERVICE || 'localhost:50052',  // secure-exchange-service 的 gRPC 端口
        userService: process.env.USER_RPC_SERVICE || 'localhost:50051'  // user-service 的 gRPC 端口
    }
};
